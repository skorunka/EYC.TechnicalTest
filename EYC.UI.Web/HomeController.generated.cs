...
namespace EYC.UI.Web.Controllers
{
    public partial class HomeController
    {
        ...
        {
            public readonly string inputForm = RetailerChargesViewModel.FormName;
        }
        ...
        public class ViewsClass
        {
            ...
            {
                public readonly string RetailerCharges = "RetailerCharges";
            }
            ...
            {
                public readonly string RetailerChargesForm = "RetailerChargesForm";
            }
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_HomeController : EYC.UI.Web.Controllers.HomeController
    {
        ...
        [NonAction]
        partial void GetSubTextPositionsOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, EYC.UI.Web.Models.Home.RetailerChargesViewModel inputForm);

        [NonAction]
        public override System.Web.Mvc.ActionResult GetSubTextPositions(EYC.UI.Web.Models.Home.RetailerChargesViewModel inputForm)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.GetSubTextPositions);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, RetailerChargesViewModel.FormName, inputForm);
